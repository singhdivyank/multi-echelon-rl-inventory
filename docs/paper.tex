...
The Clark--Scarf decomposition is the reference point for
tractable multi-echelon policies: it proves optimality of
echelon base-stock when demand is strictly stationary, i.i.d.\
and backlog dynamics are well-behaved.

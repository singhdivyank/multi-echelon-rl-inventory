...
def compare_ppo_baseline(
    ...
    ppo_mean = ppo_results['mean_cost']
    ppo_lower = ppo_results['ci_lower']
    ppo_upper = ppo_results['ci_upper']

    baseline_mean = baseline_results['mean_cost']
    baseline_lower = baseline_results['ci_lower']
    baseline_upper = baseline_results['ci_upper']

    ci_lower_ppo = ppo_mean - ppo_lower
    ci_upper_ppo = ppo_upper - ppo_mean
    ci_lower_baseline = baseline_mean - baseline_lower
    ci_upper_baseline = baseline_upper - baseline_mean
